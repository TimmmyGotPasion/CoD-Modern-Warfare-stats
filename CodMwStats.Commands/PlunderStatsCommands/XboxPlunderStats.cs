...
{
    public class XboxPlunderStats : ModuleBase<SocketCommandContext>
    {
        [Command("PlunderStats-xbl")]
        [Alias("PlStatsxbl")]
        public async Task StatsXBLPlunder([Remainder] string userName)
        {
            var jsonAsString =
            ...
            File.WriteAllBytes("Resources/XBLPlunderStats.png", bytes);
            await Context.Channel.SendFileAsync(new MemoryStream(bytes), "Resources/XBLPlunderStats.png");
        }
    }
}